...
The ministry started in the early part of 1973 as a group of men and women with a shared vision of soul-winning. As received by the set man, Bishop Oluwayimika Oduwale, they were to organise evangelical crusades and outreaches in rural and urban places.."
          ...
          <div className="split-2">
            <div className="animate-left">
              ...
              <p style={{ marginBottom: 20, fontSize: 16, lineHeight: 1.85 }}>
                ...
                We believe every person carries a unique calling and we exist to
                help you discover and walk fully in it.
              </p>
              <p style={{ marginBottom: 28, fontSize: 16, lineHeight: 1.85 }}>
                Our vision is to see transformed lives transforming communities
                — building a church that looks like heaven, where every tribe,
                tongue, and nation worships as one body.
              </p>
      ...
      <section className="section" style={{ background: "var(--cream)" }}>
        <div className="container">
          <SectionHeader
            ...
            subtitle="These values shape everything we do — from Sunday services to community outreach and winning souls."
          />
            ...
            {[
              {
                ...
                body: "Every sermon, decision and ministry is rooted firmly in the truth of God's Word.",
              },
              {
                icon: "heart",
                title: "Radical Love",
                body: "We love God with everything and extend that love unconditionally to every person.",
              },
              {
                icon: "users",
                title: "Authentic Community",
                body: "We do life together — celebrating, grieving, growing, and serving as one family.",
              },
              {
                icon: "zap",
                title: "Spirit-Led Worship",
                body: "We create space for the Holy Spirit to move freely in every gathering.",
              },
              {
                icon: "globe",
                title: "Global Mission",
                body: "We are called beyond our walls — reaching our city and the nations for Christ.",
              },
              {
                icon: "shield",
                title: "Integrity",
                body: "We are committed to transparency, accountability, and excellence in all things.",
              },
            ].map((v) => (
      ...
      <section className="section" style={{ background: "var(--white)" }}>
        <div className="container">
          <SectionHeader
            eyebrow="LEADERSHIP"
            title="Meet Our Senior Ministers"
      ...
      <section className="section" style={{ background: "var(--cream)" }}>
        <div className="container">
          <SectionHeader
            ...
            subtitle="Our faith is grounded in the timeless truths of Scripture."
          />
